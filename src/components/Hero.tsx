      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-primary bg-clip-text text-transparent">Tom Zyer</span>
          </h1>

          <p className="text-xl md:text-2xl text-foreground/80 mb-8 leading-relaxed max-w-3xl mx-auto">
            Product Marketing & Strategy Leader | Ex-Yik Yak | Kellogg MBA
          </p>

          <p className="text-lg text-foreground/70 mb-8 max-w-2xl mx-auto">
            Proven track record in growth marketing go-to-market strategy, go-to-market strategy, and operations.
          </p>
