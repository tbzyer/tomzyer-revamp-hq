      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-6">
            <span className="bg-gradient-primary bg-clip-text text-transparent">Beyond the Resume</span>
          </h2>

          <p className="text-xl text-center text-foreground/80 mb-12 max-w-2xl mx-auto">
            As a performing muscian, I bring creativity, stage presence, and teamwork to everything I do. Watch our 2025
